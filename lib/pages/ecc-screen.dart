...
class ECCScreen extends StatefulWidget {
  const ECCScreen({super.key});

  @override
  State<ECCScreen> createState() => _ECCScreen();
}

class _ECCScreen extends State<ECCScreen> {
  ...
  pickImageFromGallery() {
    ImagePicker().pickImage(source: ImageSource.gallery).then((imgFile) async {
      if (imgFile != null) {
        ...
        dbHelper!.saveE(Photo(photoName: imgString));
        refreshImages();
      } else {
        return;
      }
