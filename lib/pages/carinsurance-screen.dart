...
class CarInsuranceScreen extends StatefulWidget {
  ...
  @override
  State<CarInsuranceScreen> createState() => _CarInsuranceScreen();
}

class _CarInsuranceScreen extends State<CarInsuranceScreen> {
  ...
  pickImageFromGallery() {
    ImagePicker().pickImage(source: ImageSource.gallery).then((imgFile) async {
      if (imgFile != null) {
        ...
        dbHelper!.saveI(Photo(photoName: imgString));
        refreshImages();
      } else {
        return;
      }
