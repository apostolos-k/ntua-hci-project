...
class KteoScreen extends StatefulWidget {
  const KteoScreen({super.key});

  @override
  State<KteoScreen> createState() => _KteoScreen();
}

class _KteoScreen extends State<KteoScreen> {
  ...
  pickImageFromGallery() {
    ImagePicker().pickImage(source: ImageSource.gallery).then((imgFile) async {
      if (imgFile != null) {
        ...
        dbHelper!.saveK(Photo(photoName: imgString));
        refreshImages();
      } else {
        return;
      }
