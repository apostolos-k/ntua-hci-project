...
class CarRegistrationScreen extends StatefulWidget {
  ...
  @override
  State<CarRegistrationScreen> createState() => _CarRegistrationScreen();
}

class _CarRegistrationScreen extends State<CarRegistrationScreen> {
  ...
  pickImageFromGallery() {
    ImagePicker().pickImage(source: ImageSource.gallery).then((imgFile) async {
      if (imgFile != null) {
        ...
        dbHelper!.saveR(Photo(photoName: imgString));
        refreshImages();
      } else {
        return;
      }
