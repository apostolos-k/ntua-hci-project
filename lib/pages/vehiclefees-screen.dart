...
class VehicleFeesScreen extends StatefulWidget {
  const VehicleFeesScreen({super.key});

  @override
  State<VehicleFeesScreen> createState() => _VehicleFeesScreen();
}

class _VehicleFeesScreen extends State<VehicleFeesScreen> {
  ...
  pickImageFromGallery() {
    ImagePicker().pickImage(source: ImageSource.gallery).then((imgFile) async {
      if (imgFile != null) {
        ...
        dbHelper!.saveF(Photo(photoName: imgString));
        refreshImages();
      } else {
        return;
      }
